...
class UserPortfolioListRVAdapter(private val jwt : String, private val context: Context) : RecyclerView.Adapter<UserPortfolioListRVAdapter.ViewHolder>(), PofolLikeView {
