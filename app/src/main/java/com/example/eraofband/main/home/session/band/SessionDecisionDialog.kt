...
import com.example.eraofband.remote.applyDecision.ApplyDecisionService
import com.example.eraofband.remote.applyDecision.ApplyDecisionView
import com.example.eraofband.remote.getBand.Applicants

class SessionDecisionDialog(private val bandIdx: Int, private val applicant: Applicants): DialogFragment(), ApplyDecisionView {
